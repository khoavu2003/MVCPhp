    ...
    <div class="container">
        ...
        <?php if ($totalPages > 1): ?>
            <div class="pagination">
                <?php if ($page > 1): ?>
                    <a href="<?php echo BASE_URL; ?>/movies/top-rated?page=<?php echo $page - 1; ?>">Previous</a>
                <?php else: ?>
                    <a class="disabled">Previous</a>
                <?php endif; ?>

                <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                    <a href="<?php echo BASE_URL; ?>/movies/top-rated?page=<?php echo $i; ?>" 
                ...
                <?php if ($page < $totalPages): ?>
                    <a href="<?php echo BASE_URL; ?>/movies/top-rated?page=<?php echo $page + 1; ?>">Next</a>
                <?php else: ?>
